...
namespace WebMVC.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(IWebApiUOW uow, ApplicationRoleManager roleManager, ApplicationSignInManager signInManager, ApplicationUserManager userManager, IAuthenticationManager authenticationManager)
        {
        ...
        public ActionResult Index()
        {
           // var userRoles = _db.UserRolesInt.Include(u => u.Role).Include(u => u.User).OrderBy(a => a.Role.Name);
            var userRoles = _uow.GetRepository<IUserRoleIntRepository>().All;
        ...
        public ActionResult Details(int userId, int roleId)
        {
            ...
            var userRole = _uow.GetRepository<IUserRoleIntRepository>().GetByUserIdAndRoleId(userId, roleId);
            if (userRole == null)
            {
                return HttpNotFound();
            }
            ...
            var vm = new EditViewModel
                     {
                         ...
                         UserSelectList = new SelectList(_uow.GetRepository<IUserIntRepository>().All, "Id", "Email", userRole.UserId),
                         RoleSelectList = new SelectList(_uow.GetRepository<IRoleIntRepository>().All, "Id", "Name", userRole.RoleId)
                     };
            return View(vm);
        }
        ...
        public ActionResult Edit(EditViewModel vm)
        {
            ...
            vm.UserSelectList = new SelectList(_uow.GetRepository<IUserIntRepository>().All, "Id", "Email", vm.UserRole.UserId);
            vm.RoleSelectList = new SelectList(_uow.GetRepository<IRoleIntRepository>().All, "Id", "Name", vm.UserRole.RoleId);
            return View(vm);
        }
        ...
        {
            _uow.GetRepository<IUserRoleIntRepository>().DeleteByUserIdAndRoleId(userId, roleId);
            return RedirectToAction("Index");
        }
