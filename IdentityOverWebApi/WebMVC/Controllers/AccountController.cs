...
namespace WebMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
		...
		public AccountController(
            ...
            IAuthenticationManager authenticationManager, WebApiTokenStore webApiTokenStore)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    Session["token"] = _webApiTokenStore.
                        GetTokenResponse(model.Email, model.Password).AccessToken;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    Session["token"] = _webApiTokenStore.GetTokenResponse(model.Email, model.Password).AccessToken;
